...
def model(params, number):
    ...
    BEST_MODEL_FNAME = f'/ghome/group06/lab4_C3_G06/weights/best_weights_3.keras'
    ...
    return history, result, total_parameters, ratio
...
def objective_model_cv(trial):
    ...
    execution_name = 'Lab4_test_'+str(params['lr'])

    wandb.init(
        project='Lab4_optuna_lr',
        entity='c3_mcv',
        name=execution_name,
        config=config,
        reinit=True,
